...
x=Variable(    container=solver,    name="nguyen_lieu_order_truoc",    domain=j,    type="positive")
y1=Variable(    container=solver,    name="nguyen_lieu_du_th1",    domain=j,    type="positive")
y2=Variable(    container=solver,    name="nguyen_lieu_du_th2",    domain=j,    type="positive")
z1=Variable(    container=solver,    name="san_pham_san_xuat_th1",    domain=i,    type="positive")
z2=Variable(    container=solver,    name="san_pham_san_xuat_th2",    domain=i,    type="positive")
